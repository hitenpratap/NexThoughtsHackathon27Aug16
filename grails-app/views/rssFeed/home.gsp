...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="${resource(dir: 'css/incss', file: 'bootstrap.min.css')}">
    <link rel="stylesheet" href="${resource(dir: 'css/incss', file: 'magnific-popup.css')}">
    <link rel="stylesheet" href="${resource(dir: 'css/incss', file: 'owl.carousel.css')}">
    <link rel="stylesheet" href="${resource(dir: 'css/incss', file: 'main.css')}">
    <link rel="stylesheet" href="${resource(dir: 'css/incss', file: 'responsive.css')}">
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img class="main-logo img-responsive" src="${resource(dir: 'images', file: 'logo.png')}" alt="">
                    </a>
                </div>
                                ...
                                <div class="top-user-form">
                                    <form id="top-login" role="form">
                                        <div class="input-group" id="top-login-username">
                                            <span class="input-group-addon"><img src="${resource(dir: 'images/others', file: 'user-icon.png')}" alt="" /></span>
                                            <input type="text" class="form-control" placeholder="Username" required="">
                                        </div>
                                        <div class="input-group" id="top-login-password">
                                            <span class="input-group-addon"><img src="${resource(dir: 'images/others', file: 'password  -icon.png')}" alt="" /></span>
...
<!--/#scripts-->
<script src="${resource(dir: 'js/injs', file: 'jquery.js')}" type="text/javascript"></script>
<script src="${resource(dir: 'js/injs', file: 'bootstrap.min.js')}" type="text/javascript"></script>
<script src="${resource(dir: 'js/injs', file: 'jquery.magnific-popup.min.js')}" type="text/javascript"></script>
<script src="${resource(dir: 'js/injs', file: 'owl.carousel.min.js')}" type="text/javascript"></script>
<script src="${resource(dir: 'js/injs', file: 'main.js')}" type="text/javascript"></script>
